...
public class VereinsMitgliedClient {
	...
	public static void main(String args[]) {
		try {
			...
			//objRef = ncRef.resolve(serv);
		
			//VereinsMitglied vereinMitgliedRef = VereinsMitgliedHelper.narrow(objRef);
			//vereinMitgliedRef.erhoeheBeitrag("fussball", (short) 600);
			
			//System.out.println("Name: " + vereinMitgliedRef.mname());
		} catch (Exception e) {

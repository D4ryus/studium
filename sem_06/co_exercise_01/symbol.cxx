...
symtable *actsym = NULL;	/* Zeiger auf zum aktuellen Block gehörende Symboltabelle */
symtable *firstsym;		/* Zeiger auf die zum äussersten Block gehörende Symboltabelle */
...
insert(int tok)
{
	...
	switch (tok) { /* Art eintragen abhängig von tok */
		...
		case PROC:
			/*
			 * bei Prozedur: ST für lokale Deklarationen der neuen Prozedur
...
printsymtab(symtable *sptr)
{
	...
	fsym << "Anzahl der Einträge:" << sptr->anzahl << "\n";
